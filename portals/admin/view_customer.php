        ...
        <div class="row">
            <?php 
              if(isset($_GET['customer_edit_id'])){
                ...
                $customer_id=$_GET['customer_edit_id'];

                $profile_data=$obj->getSingleCustomer($customer_id);
              }
            ?>
            <div class="col-md-4">
              <div class="card card-user">
                ...
                <div class="card-body">
                  <div class="author">
                    <a href="#">
                      <img class="avatar border-gray" src="<?php echo '../../uploads/'.$profile_data['customer_pic'] ?>"  onerror="this.src='../assets/img/logo-small.png';">
                    ...
                    <div class="row">
                      <div class="col-md-4 pr-1">
                        <div class="form-group">
                          ...
                          <input type="hidden" class="form-control" name="id_field" placeholder="enter email address" value="<?php echo $profile_data['account_id']; ?>">
                        </div>
                      </div>
                      <div class="col-md-4 px-1">
                        <div class="form-group">
                          <label>Password</label>
                          <input type="text" class="form-control" name="password_field" placeholder="enter password" value="<?php echo $profile_data['password']; ?>"  required="true">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 pl-1">
                        <div class="form-group">
                          ...
                          <input type="number" name="zip_field" class="form-control" placeholder="enter zip code" value="<?php echo $profile_data['zip']; ?>" required="true">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" rows="5" name="about_field" required="true"><?php echo $profile_data['about_me']; ?></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="update ml-auto mr-auto">
                        <button type="submit" name="update_customer_btn" class="btn btn-primary btn-round">Update Profile</button>
                      </div>
                    </div>
                  </form>
                </div>
