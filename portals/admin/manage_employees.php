                      ...
                      <tbody>
                          ...
                          ?>
                                ...
                                <tr>
                                  ...
                                  <td class="text-center">
                                    <?php
                                      if($employee['store_title']==""){
                                    ?>
                                          <label>Independent Tech</label>
                                    <?php
                                      }
                                      else{
                                    ?>
                                  ...
                                  <td class="text-center">
                                    <a href="<?php echo 'view_employee.php?employee_edit_id='.$employee['tech_id']; ?>" title="Edit Employee"><i class="fa fa-edit fa-2x text-info"></i></i></a>
                                    <?php
                                      if($employee['status']=='Active'){
                                    ?>
