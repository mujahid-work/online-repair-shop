        ...
        <form action="ExeFile.php" method="post" enctype="multipart/form-data">
	        <div class="row">
	            <?php
	                ...
	                $profile_data=$obj->getSingleCustomer();
	            ?>
	            ...
	            <div class="col-md-4">
		            <div class="card card-user">
		                ...
		                <div class="card-body">
		                  <div class="author">
		                    <a href="#">
		                      <img id="output_image"  onclick="$(#file).click()" class="avatar border-gray" src="<?php echo '../../uploads/'.$profile_data['customer_pic'] ?>"  onerror="this.src='../assets/img/logo-small.png';">
		                    </a>
		                ...
		                <div class="card-body">
			            	...
			            	<div class="row">
		                      <div class="update ml-auto mr-auto">
		                        <button type="submit" class="btn btn-success btn-round" name="update_customer_btn">Update Profile</button>
		                      </div>
		                    </div>
		                </div>
		            </div>
