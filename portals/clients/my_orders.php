              ...
              <div class="wizard-container">
                <div class="card wizard-card" data-color="red" id="wizard">
                  ...
                  <div class="wizard-navigation" style="background-color: black;">
                      <ul>
                          <li><a href="#new" data-toggle="tab">My New Orders</a></li>
                          <li><a href="#in-progress" data-toggle="tab">My In-Progress Orders</a></li>
                          <li><a href="#completed" data-toggle="tab">My Completed Orders</a></li>
                          <li><a href="#cancled" data-toggle="tab">My Cancled Canceled</a></li>
                      </ul>
                  </div>                  
                                        ...
                                        <tbody>
                                          ...
                                          ?>
                                                <tr>
                                                  ...
                                                  <td class="text-center"><?php echo $order['first_name'].' '.$order['last_name']; ?></td>
                                                  <td class="text-center"><?php echo $order['contact_number']; ?></td>
