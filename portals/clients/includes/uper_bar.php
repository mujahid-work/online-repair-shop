  ...
  <div class="col-lg-3 col-md-6 col-sm-6">
      <div class="card card-stats">
          ...
          <div class="row">
            ...
            <div class="col-7 col-md-8">
              <div class="numbers">
                  ...
                  ?>
                <p class="card-category">My New Repair Orders</p>
        ...
        <div class="card-footer ">
          ...
          <div class="stats">
            <i class="nc-icon nc-ruler-pencil text-info"></i>
            <a href="my_orders.php" style="color: grey;">View All Orders</a>
          </div>
        </div>
      </div>
  </div>
          ...
          <div class="row">
            ...
            <div class="col-7 col-md-8">
              <div class="numbers">
                  ...
                  ?>
                <p class="card-category">My In-Progress Repair Orders</p>
                <p class="card-title"><?php echo $total_count; ?><p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-7 col-md-8">
              <div class="numbers">
                  ...
                  ?>
                <p class="card-category">My Completed Repair Orders</p>
                <p class="card-title"><?php echo $total_count; ?><p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-7 col-md-8">
              <div class="numbers">
                  ...
                  ?>
                <p class="card-category">My Cancelled Repair Orders</p>
                <p class="card-title"><?php echo $total_count; ?><p>
              </div>
            </div>
          </div>
