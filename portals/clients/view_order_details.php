					            ...
					            <div class="card card-user">
					                <div class="card-header">
					                	<div class="row">
						              		...
						              		<div class="col-md-4">
						              			<!-- <a href="#" class="btn btn-success" style="margin-top: -2px;"><i class="fa fa-print"></i> Print Receipt</a> -->
						              		</div>
						              	</div>
					                </div>
					                <div class="card-body">
								                        		...
								                        		<div class="row">
													        		<div class="col-md-12">
													        			<div class="form-group">
													                        ...
													                        <input type="text" class="form-control" readonly="true" value="<?php echo $order_details['order_status']; ?>">
													                        <input name="order_id_field" type="hidden" class="form-control" value="<?php echo $order_details['order_id']; ?>">
													                    </div>
													        		</div>
													        		<?php 
													        			if($order_details['order_status']=='New'){
													        		?>
													        				<div class="col-md-12">
															        			<div class="form-group">
															                        <a href="<?php echo 'ExeFile.php?order_status=1&&order_id='.$order_details['order_id']; ?>" class="btn btn-danger col-md-12">Cancel Order</a>
															                    </div>
													        				</div>		
													        		<?php
													        			}
