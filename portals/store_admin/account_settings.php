                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          <img style=" width: 200px; height: 200px;" class="" src="<?php echo '../../uploads/'.$my_profile['store_admin_pic'];?>" onerror="this.src='../assets/img/logo-small.png';">
                        </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name_field" placeholder="enter full name" value="<?php echo $my_profile['store_admin_full_name']; ?>" required="true">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mobile_field" placeholder="enter contact number" value="<?php echo $my_profile['store_admin_mobile']; ?>" required="true">
                      </div>
                    </div>
                  </div>
                  <br>
