<?php
    ...
    $low_parts_alerts=$obj->getLowQtyParts();
?>
...
<body class="" >
  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
          <?php
                if(!empty($low_parts_alerts)){
                  foreach ($low_parts_alerts as $low) {
          ?>
                    ...
                    <div class="alert alert-danger alert-dismissible fade show">
                      ...
                      <span>
                        <strong style='text-decoration:underline;'> Heads Up! </strong> <br> <b>"<?php echo $low['part_title']; ?>"</b> is low in your inventory.Current quantity is <b>"<?php echo $low['qty']; ?>"</b>.
                    </div>
