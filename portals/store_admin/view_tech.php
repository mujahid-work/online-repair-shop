        ...
        <div class="row">
            <?php 
              if(isset($_GET['employee_edit_id'])){
                ...
                $tech_id=$_GET['employee_edit_id'];

                $profile_data=$obj->getSingleTechnician($tech_id);
              }
            ?>
            <div class="col-md-4">
              <div class="card card-user">
                ...
                <div class="card-body">
                  <div class="author">
                    <a href="#">
                      <img class="avatar border-gray" src="<?php echo '../../uploads/'.$profile_data['tech_pic'] ?>"  onerror="this.src='../assets/img/logo-small.png';">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="store_field" style="height: 45px;">
                            ...
                            ?>
                                  <option value="<?php echo $store['store_id']; ?>" <?php if($store['store_id']==$profile_data['store_id']){ echo 'selected';} ?>>
