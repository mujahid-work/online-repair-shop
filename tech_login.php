...
<head>
  <meta charset="utf-8">
  <title>eStartup | Technician Login</title>
        	...
        	<div class="row">
				<div class="col-lg-12 col-md-12" style="background-color: #eff2f5;">
				          ...
				          <div class="form">
				            <form action="ExeFile.php" method="post">
				              ...
				              <div class="text-center">
				                <button type="submit" class="btn btn-primary" name="tech_login_btn">Login</button>
				              </div>
				            </form>
				          </div>
				        </div>
				    ...
				    <div class="container mt-5">
			          <div class="section-title text-center">
			            <p class="separator">No account? <a href="tech_signup.php"> Signup </a> |  <a href="#"> Forgot Password? </a></p>
			          </div>
			        </div>
		    	</div>
			</div>				    
